      ...
      <div class="box">
            <div class="box-header with-border">
              ...
              <div class="pull-right">
                <button type="button" class="btn <?php echo __static::bg_color(Auth::user()->color); ?>" data-toggle="modal" data-target="#add_seminar_modal"><i class="fa fa-plus"></i> New GST</button>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
      ...
      <div class="modal-content">
        ...
        <form autocomplete="off" id="form_add_seminar" enctype="multipart/form-data">  
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn <?php echo __static::bg_color(Auth::user()->color); ?> submit_add_seminar"><i class="fa fa-save"></i> Save</button>
          </div>
...
<?php echo __html::blank_modal('participant_modal','80'); ?>


<?php echo __html::blank_modal('edit_participant_modal','','100px'); ?>
    ...
    buttons: {
        confirm:{
           ...
           action: function(){
            ...
            uri = "<?php echo e(route('dashboard.seminar.participant_destroy', 'slug')); ?>";
...
<script type="text/javascript">
    ...
    //-----DATATABLES-----//
      ...
      seminars_table = $("#seminars_table").DataTable({
        ...
        "processing": true,
        "serverSide": true,
        "ajax" : '<?php echo e(route("dashboard.seminar.index")); ?>',
        "columns": [
            { "data": "slug" },
            { "data": "seminar_id" },
            { "data": "title" },
    ...
    //-----SEMINAR-----//
      ...
      $("#form_add_seminar").submit(function(e){
        ...
        Pace.restart();
        $.ajax({
          url: "<?php echo e(route('dashboard.seminar.store')); ?>",
          data: formData,
          type: "POST",
          dataType: 'json',
          processData: false,
      ...
      $("body").on("click", ".edit_seminar_btn", function(){
        ...
        id = $(this).attr('data');
        uri = "<?php echo e(route('dashboard.seminar.edit', 'slug')); ?>";
          ...
          success: function(response){
            ...
            $("#edit_seminar_modal_loader").fadeOut(function(){
              ...
              $("#edit_seminar_form").submit(function(e){
                ...
                e.preventDefault();
                uri = "<?php echo e(route('dashboard.seminar.update', 'slug')); ?>";
                uri = uri.replace('slug',id);
                formData = new FormData(this);
                Pace.restart();
                $.ajax({
      ...
      $("body").on("click", ".delete_seminar_btn", function(){
        id = $(this).attr('data');
        confirm("<?php echo e(route('dashboard.seminar.destroy', 'slug')); ?>", id);
      })
      ...
      $("body").on("click", ".view_seminar_btn", function(){
        ...
        id = $(this).attr("data");
        uri = '<?php echo e(route("dashboard.seminar.show", "slug")); ?>';
        uri = uri.replace('slug',id);
        Pace.restart();
        $.ajax({
          url : uri,
    ...
    //-----SEMINAR PARTICIPANTS-----//
      ...
      $("body").on("click", ".participant_btn",function(){
        id = $(this).attr('data');
        uri = "<?php echo e(route('dashboard.seminar.participant', 'slug')); ?>";
        uri = uri.replace('slug',id);
      ...
      $("body").on("submit","#add_participant_form", function(e){
          ...
          e.preventDefault();
          uri = "<?php echo e(route('dashboard.seminar.participant_store' ,'slug')); ?>";
      ...
      $("body").on("click",".edit_participant_btn", function(){
        ...
        $.ajax({
          url : "<?php echo e(route('dashboard.seminar.participant_edit', 'slug')); ?>?slug="+participant_slug,
          type: 'GET',
          success: function(response){
      ...
      $("body").on("submit","#edit_participant_form", function(e){
        e.preventDefault();
        slug = $(this).attr('data');
        uri = "<?php echo e(route('dashboard.seminar.participant_update' , 'slug')); ?>";
        uri = uri.replace('slug',slug);
