  ...
  <div class="wrapper" style="overflow:hidden !important;">
    ...
    <div class="row" style="padding-bottom: 10px;">
      ...
      <div class="col-sm-4">
        ...
        <div class="col-sm-9 std_div">
          <?php echo e(__dataType::date_parse($sugar_oop->date, 'F d,Y')); ?>
      ...
      <div class="col-sm-6">
        ...
        <div class="col-sm-7 std_div no-padding">
          <?php echo e($sugar_oop->received_from); ?>
      ...
      <div class="col-sm-6">
        ...
        <div class="col-sm-7 std_div no-padding" >
          <?php echo e($sugar_oop->sugarSample->name); ?>
      ...
      <div class="col-sm-6">
        ...
        <div class="col-sm-7 std_div no-padding">
          <?php echo e($sugar_oop->sample_no); ?>
      ...
      <div class="col-sm-6">
        ...
        <div class="col-sm-7 std_div no-padding">
          ...
          <?php if($sugar_oop->sugar_sample_id == $sugar_samples_static['cja']): ?>
            Polarization, Corrected Brix, Purity
          <?php elseif(!$sugar_oop->sugarAnalysisParameter->isEmpty()): ?>
    ...
    <div class="row">
      ...
      <div class="col-sm-12 std_div" style="margin-bottom: 20px; text-align: center;">
        <?php echo e($sugar_oop->total_price > 0 ? __dataType::num_to_words($sugar_oop->total_price) . ' PESOS' : ''); ?>      
      </div>

      <div class="col-sm-12 std_font_size" style="margin-bottom: 10px;">
        <p style="font-weight: bold;">
          Pesos (PhP <span style="text-decoration: underline;"><?php echo e(number_format($sugar_oop->total_price, 2)); ?></span>)
        </p>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-6" style="margin-bottom: 20px;">
        ...
        <div class="col-sm-8 std_div" style="text-align: center;">
          <?php echo e($sugar_oop->received_by); ?>
