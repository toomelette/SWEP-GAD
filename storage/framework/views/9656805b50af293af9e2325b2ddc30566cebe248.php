  ...
  <div class="row">
    <div class="col-md-4">
      <div class="box box-widget widget-user">
        ...
        <div class="widget-user-header bg-aqua" style="background: url(<?php echo e(asset('images/sra.jpg')); ?>) center center; background-size: cover;">
          <h3 class="widget-user-username"><?php echo e(Auth::check() ? Auth::user()->fullname : ''); ?></h3>
          <h5 class="widget-user-desc"><?php echo e(Auth::check() ? Auth::user()->position : ''); ?></h5>
        </div>
        <div class="widget-user-image image_o" data-content="CHANGE" id="img-circ">
    
            <img class="img-circle"  src="<?php echo __html::check_img(Auth::user()->image); ?>" alt="User Avatar">
          ...
          <div class="row">
            <div class="col-sm-6 border-right">
              <div class="description-block">
                <h5 class="description-header"><?php echo e(number_format($total_encoded)); ?></h5>
            ...
            <div class="col-sm-6 border-right">
              <div class="description-block">
                <h5 class="description-header"><?php echo e(number_format($total_updated)); ?></h5>
          ...
          <ul class="nav nav-stacked">
            ...
            <li>
              <a href="#">
                ...
                <span class="pull-right text-strong">
                  <?php echo e(Auth::user()->middlename); ?>
            ...
            <li>
              <a href="#">
                ...
                <span class="pull-right text-strong">
                  <?php echo e(__dataType::date_parse(Auth::user()->last_login_time, 'M d, Y h:i A')); ?>
            ...
            <li>
              <a href="#">
                ...
                <span class="pull-right text-strong">
                  <?php echo e(Auth::user()->last_login_machine); ?>
            ...
            <li>
              <a href="#">
                ...
                <span class="pull-right text-strong">
                  <?php echo e(Auth::user()->last_login_ip); ?>
          ...
          <div class="tab-pane " id="activity_logs">
                    ...
                    <div class="col-md-1 col-sm-2 col-lg-2">
                      ...
                      <select name="scholars_table_length" aria-controls="scholars_table" class="form-control input-sm module filters">
                        ...
                        <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($module); ?>"><?php echo e($key); ?></option>
                    ...
                    <div class="col-md-1 col-sm-2 col-lg-2">
                      ...
                      <select name="scholars_table_length" aria-controls="scholars_table" class="form-control input-sm event filters">
                        ...
                        <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($event); ?>"><?php echo e($key); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
            ...
            <div id="activity_logs_container" style="display: none">
              <table class="table table-bordered table-striped" id="activity_logs_table" style="width: 100% !important; font-size: inherit;">
                <thead>
                  <tr class="<?php echo e(__static::bg_color(Auth::user()->color)); ?>">
                    <th>Module</th>
                    <th>Event</th>
                    <th>Action</th>
                    <th>Timestamp</th>
                  ...
                  <div class="col-sm-12">
                    <div class="scrolling-wrapper">
                      <?php
                        ...
                        ksort($themes);
                      ?>
                      <?php $__currentLoopData = $themes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(Auth::user()->color == $color): ?>
                          <?php
                            $bg = 'bg-success';
                        ...
                        <?php else: ?>
                          ...
                          ?>
                        <?php endif; ?>
                        <div class="scrolling-card" data="<?php echo e($color); ?>">
                          <ul class="mailbox-attachments clearfix">
                            <li class="scrolling-li <?php echo e($bg); ?>" data="<?php echo e($color); ?>">
                               <span class="mailbox-attachment-icon has-img"><img src="<?php echo e(asset('images/skins')); ?>/<?php echo e($color); ?>.jpg"></span>

                              <div class="mailbox-attachment-info">
                                <a href="#" class="mailbox-attachment-name"><?php echo e($key); ?>
...
<div id="change_pp" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    ...
    <div id="img_loader" style="display: none">
      <center>
        <img style="width: 100px" src="<?php echo e(asset('images/loader.gif')); ?>">
      </center>
    </div>
    <br>
...
<?php $__env->startSection('scripts'); ?>
  <script type="text/javascript">
    function filter_dt(){
      ...
      activity_tbl.ajax.url(
        "<?php echo e(route('dashboard.profile.details')); ?>?mod="+mod+"&event="+event+"&date_range="+date_range).load();
  ...
  <script type="text/javascript">
    ...
    activity_tbl = $("#activity_logs_table").DataTable({
      ...
      "processing": true,
      "serverSide": true,
      "ajax" : '<?php echo e(route("dashboard.profile.details")); ?>',
      "columns": [
          { "data": "module" },
          { "data": "event" },
          { "data": "remarks" },
    ...
    $(".scrolling-card").click(function(event) {
      ...
      $.ajax({
        url: "<?php echo e(route('dashboard.profile.update_account_color')); ?>",
        data: {color:color},
        type: "PATCH",
        headers: {
    ...
    $("#username_form").submit(function(e) {
      ...
      $.ajax({
        url : "<?php echo e(route('dashboard.profile.update_account_username')); ?>",
        data: $(this).serialize(),
        type: "PATCH",
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $("#password_form").submit(function(e) {
      ...
      $.ajax({
        url: "<?php echo e(route('dashboard.profile.update_account_password')); ?>",
        data: $(this).serialize(),
        type: "PATCH",
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      ...
      $('#btnCrop').on('click', function () {
        ...
        if (cropper) {
          ...
          canvas.toBlob(function (blob) {
            ...
            $.ajax({
              url : '<?php echo e(route('dashboard.profile.update_image')); ?>',
              method: 'POST',
              data: formData,
              processData: false,
              contentType: false,
