            ...
            <div class="box-header with-border">
              ...
              <div class="pull-right">
                <div class="btn-group">
                  ...
                  <button type="button" class="btn <?php echo __static::bg_color(Auth::user()->color); ?>" data-toggle="modal" data-target="#add_menu_modal"><i class="fa fa-plus"></i> Add new</button>
                </div>
              </div>
            </div>
            <div class="panel">
...
<?php echo __html::blank_modal('show_menu_modal','lg'); ?>

<?php echo __html::blank_modal('edit_menu_modal','sm'); ?>

<?php echo __html::blank_modal('list_submenus','lg'); ?>
    ...
    buttons: {
        confirm:{
           ...
           action: function(){
            ...
            uri = "<?php echo e(route('dashboard.submenu.destroy', 'slug')); ?>";
...
function filter_dt(){
    ...
    menu_tbl.ajax.url(
      "<?php echo e(route('dashboard.menu.index')); ?>?is_menu="+is_menu+"&is_dropdown="+is_dropdown).load();
...
<script type="text/javascript">
  ...
  //-----DATATABLES-----//
    ...
    menu_tbl = $("#menu_table").DataTable({
      "processing": true,
      "serverSide": true,
      "ajax" : '<?php echo e(route("dashboard.menu.index")); ?>',
      "columns": [
          { "data": "order" },
          { "data": "name" },
          { "data": "route" },
    ...
    $(".change_menu_btn").click(function(){
      ...
      $.ajax({
        url : "<?php echo e(route('dashboard.menu.get_menus')); ?>",
        type : "GET",
        success: function(response){
    ...
    $("body").on("click",".submit_reorder_btn",function(){
      ...
      uri = "<?php echo e(route('dashboard.menu.reorder_menus')); ?>";
      $.ajax({
        url: uri ,
        data: {array:array},
        type: 'GET',
    ...
    $("#add_menu_form").submit(function(e) {
      ...
      $.ajax({
        url : "<?php echo e(route('dashboard.menu.store')); ?>",
        data: $(this).serialize(),
        type: 'POST',
        dataType: 'json',
        success: function(response){
    ...
    $("body").on("click",".list_submenus_btn", function(){
      ...
      $.ajax({
        url : "<?php echo e(route('dashboard.submenu.index')); ?>",
        data: {menu_slug : id},
        type: "GET",
        success: function(response){
          $("#list_submenus #modal_loader").fadeOut(function() {
            ...
            $("#add_submenu_form").submit(function(e){
              ...
              $.ajax({
                url: "<?php echo e(route('dashboard.submenu.store')); ?>",
                type: "POST",
    ...
    $("body").on("click",".edit_menu_btn", function(){
      ...
      uri = "<?php echo e(route('dashboard.menu.edit','slug')); ?>";
    ...
    $("body").on("submit","#edit_menu_form", function(e){
      ...
      uri = "<?php echo e(route('dashboard.menu.update','slug')); ?>";
      uri = uri.replace("slug",id);
    ...
    $("body").on("click",".delete_menu_btn" ,function(){
      id = $(this).attr("data");
      confirm("<?php echo e(route('dashboard.menu.destroy','slug')); ?>", id);
    });
    ...
    $("body").on("click",".edit_submenu_btn", function(){
      ...
      uri = "<?php echo e(route('dashboard.submenu.edit','slug')); ?>",
      uri = uri.replace('slug', id);
      $.ajax({
        url : uri,
        type: 'GET',
    ...
    $("body").on("submit","#edit_submenu_form", function(e){
      e.preventDefault();
      id = $(this).attr("data");
      uri = "<?php echo e(route('dashboard.submenu.update','slug')); ?>";
      uri = uri.replace('slug', id);
