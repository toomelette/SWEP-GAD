      ...
      <div class="box">
            <div class="box-header with-border">
              ...
              <div class="pull-right">
                <button type="button" class="btn <?php echo __static::bg_color(Auth::user()->color); ?>" data-toggle="modal" data-target="#add_scholar_modal"><i class="fa fa-plus"></i> New Scholar</button>
              </div>
            </div>
            <div class="panel">
              <div class="box-header with-border">
            ...
            <div class="box-body">
              ...
              <div id="tbl_loader">
                <center>
                  ...
                  src="<?php echo __static::loader(Auth::user()->color); ?>">
                </center>
              </div>
            </div>
            <!-- /.box-body -->
...
<script type="text/javascript">
  ...
  function filter_dt(){
    ...
    scholars_tbl.ajax.url(
      "<?php echo e(route('dashboard.scholars.index')); ?>?sex="+sex+"&scholarship_type="+scholarship_type+"&mill_district="+mill_district+"&course="+course).load();
...
<script type="text/javascript">
  ...
  scholars_tbl = $("#scholars_table").DataTable({
    ...
    "serverSide": true,
    "ajax" : {
      url : '<?php echo e(route("dashboard.scholars.index")); ?>',
      type: 'GET',
    },
    "columns": [
        { "data": "fullname" },
  ...
  $("body").on("click",".show_scholars_btn",function(){
    ...
    uri = "<?php echo e(route('dashboard.scholars.show','slug')); ?>";
  ...
  $("body").on("click",".edit_scholars_btn", function(){
    ...
    uri = " <?php echo e(route('dashboard.scholars.edit', 'slug')); ?> ";
    uri = uri.replace('slug',id);
  ...
  $("body").on("click",".delete_scholars_btn", function(){
    id = $(this).attr('data');
    confirm("<?php echo e(route('dashboard.scholars.destroy', 'slug')); ?>", id);
  })
