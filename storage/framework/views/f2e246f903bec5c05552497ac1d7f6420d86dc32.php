<form id="edit_scholars_form" data="<?php echo e($scholars->slug); ?>" autocomplete="off" >
	<?php echo csrf_field(); ?>
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal">&times;</button>
		<h4 class="modal-title"><?php echo e($scholars->lastname); ?>, <?php echo e($scholars->firstname); ?> - Edit</h4>
	</div>
